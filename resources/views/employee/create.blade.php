            ...
            <div class="card col s12 m12 l12 xl12 mt-20">
                ...
                <div class="card-content">
                    ...
                    <form action="{{route('employees.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        @isset($getid->id)
                            <input type="text" name="emp_id" id="emp_id" value="{{$getid->id+1}}">
                        @endisset
                        </div>
                        <div class="row">
...
{{--                                          class="materialize-textarea">{{Request::old('address') ? : ''}}</textarea>--}}
...
{{--                                    <option value="" disabled {{ old('city') ? '' : 'selected' }}>เลือกจังหวัด</option>--}}
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="country">
{{--                                    <option value="" disabled {{ old('country') ? '' : 'selected' }}>เลือกประเทศ--}}
{{--                                    </option>--}}
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="salary">
                                    <option value="" disabled {{ old('salary') ? '' : 'selected' }}>เลือกเงินเดือน
                                    </option>
...
{{--                            </div>--}}
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="department">
                                    <option value="" disabled {{ old('department') ? '' : 'selected' }}>เลือกแผนก
                                    </option>
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="division">
                                    <option value="" disabled {{ old('division') ? '' : 'selected' }}>เลือกสายงาน
                                    </option>
