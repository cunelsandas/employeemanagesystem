    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2 card-mt-15">
                <h4 class="center grey-text text-darken-2 card-title">เพิ่มข้อมูลเงินเดือน</h4>
                <div class="card-content">
                    <div class="row">
                        <form action="{{route('salaries.store')}}" method="POST">
                            <div class="input-field no-margin">
                                <i class="material-icons prefix">attach_money</i>
                                <input type="number" name="s_amount" id="s_amount" min="0" class="validate" value="{{ Request::old('s_amount') ? : '' }}">
                                <label for="s_amount">จำนวนเงินเดือน</label>
