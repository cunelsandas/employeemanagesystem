    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                <div>
                <h4 class="center grey-text text-darken-2 card-title">เพิ่มพนักงานใหม่</h4>
                </div>
                <hr>
                    ...
                    <form action="{{route('employees.store')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6 l6 xl4 offset-xl2">
                                ...
                                <select name="state">
                                    <option value="" disabled {{ old('state') ? '' : 'selected' }} >เลือกอำเภอ</option>
                            ...
                            <div class="input-field col s12 m6 l6 xl4">
                                ...
                                <select name="city">
                                    <option value="" disabled {{ old('city') ? '' : 'selected' }}>เลือกจังหวัด</option>
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="country">
                                    <option value="" disabled {{ old('country') ? '' : 'selected' }}>เลือกประเทศ</option>
                            ...
                            <div class="input-field col s12 m6 l6 xl4">
                                ...
                                <select name="salary">
                                    <option value="" disabled {{ old('salary') ? '' : 'selected' }}>เลือกเงินเดือน</option>
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="department">
                                    <option value="" disabled {{ old('department') ? '' : 'selected' }}>เลือกแผนก</option>
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="division">
                                    <option value="" disabled {{ old('division') ? '' : 'selected' }}>เลือกสายงาน</option>
                        ...
                        @csrf()
                        <div class="row">
                            <button type="submit" class="btn waves-effect waves-light col s8 offset-s2 m4 offset-m4 l4 offset-l4 xl4 offset-xl4">เพิ่มข้อมูล</button>
                        </div>
                    </form>
                </div>
